/**
 * Multi-Timeframe Trading Page
 * Professional multi-timeframe analysis with synchronized charts
 */
...
const MultiTimeframe: React.FC = () => {
  ...
  const handleStockSelect = (symbol: string) => {
    ...
    console.log(`Selected stock: ${fullSymbol}`);
  ...
  return (
    <div className="flex min-h-screen bg-[#131722] text-white">
      {/* Sidebar */}
      <Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />

      {/* Main Content */}
      <div className="flex-1 ml-64 overflow-y-auto">
        {/* Top Bar - Stock Selector & Info */}
        <div className="sticky top-0 z-10 bg-[#1e222d] border-b border-[#2a2e39] px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex-1 max-w-xl">
              <StockSelector 
                value={activeSymbol.replace('.NS', '')} 
        ...
        <div className="p-6">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">
                  Synchronized charts with HTF level overlays and alignment indicators
                </p>
              </div>
            </div>
          </div>

          {/* Timeframe Selector - Redesigned */}
          <div className="bg-gradient-to-br from-[#1e222d] to-[#1a1e28] rounded-2xl p-6 mb-6 border border-[#2a2e39] shadow-xl">
          ...
          <MultiTimeframeView
            ...
            defaultLayout={timeframes.length === 1 ? 1 : timeframes.length === 2 ? 2 : 4}
            enableSync={true}
            showHTFLevels={true}
            showAlignment={true}
          />
